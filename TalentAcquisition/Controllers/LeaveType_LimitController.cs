...
namespace TalentAcquisition.Controllers
{
    public class LeaveType_LimitController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LeaveType,Limit")] LeaveType_Limit leaveType_Limit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LeaveType,Limit")] LeaveType_Limit leaveType_Limit)
        {
            if (ModelState.IsValid)
            {
